...
public class AttackingContext {
    ...
    public static final AttackingContext barbTwoHandedSword = new AttackingContext(CharacterClass.BARBARIAN, 40, 2);
    public static final AttackingContext barbOneHandedSword = new AttackingContext(CharacterClass.BARBARIAN, 40, 1);
